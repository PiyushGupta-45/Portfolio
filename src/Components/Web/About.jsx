    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-black to-gray-900 text-white px-6">
      <div className="max-w-3xl text-center">
        ...
        <p className="text-lg text-gray-300 leading-relaxed">
          Hi! I'm <span className="text-purple-400 font-semibold">Piyush Gupta</span>, a passionate Full-Stack Developer and a 3rd-year student. I love building
        ...
        <div className="mt-6">
          <Link to="/work" className="px-6 py-3 bg-purple-600 hover:bg-purple-700 rounded-lg text-white text-lg font-semibold transition-all">View My Work</Link>
        </div>
      </div>
    </div>
  );
