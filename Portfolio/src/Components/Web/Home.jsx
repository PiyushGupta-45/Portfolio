  ...
  return (
    <main className='relative min-h-screen overflow-hidden bg-[#020409] px-4 pb-10 pt-[7.6rem] text-[#f3f5fb] sm:px-8 lg:px-12 xl:px-16'>
      ...
      <section className='relative z-10 mx-auto mb-6 grid w-full max-w-[1380px] grid-cols-[1.35fr_0.95fr] items-stretch gap-5 max-[1180px]:grid-cols-1'>
        <div className='anim-fade-left flex min-h-[31rem] flex-col justify-center rounded-[24px] border border-[#24314e] bg-[linear-gradient(160deg,rgba(10,15,28,0.86)_0%,rgba(7,11,22,0.9)_100%)] px-8 py-9 shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_20px_50px_rgba(0,0,0,0.45)] max-sm:min-h-[22rem] max-sm:px-5 max-sm:py-7'>
        ...
        <aside className='grid h-full grid-rows-[1fr_1.15fr_1fr_0.75fr] gap-2.5'>
          ...
          <p className='anim-fade-right anim-delay-2 m-0 h-full rounded-xl border border-[#23324f] bg-[rgba(8,14,27,0.78)] px-4 py-3 text-[clamp(1rem,1.32vw,1.85rem)] leading-[1.35] text-[#aeb6cb]'>
          ...
          <div className='anim-fade-right anim-delay-3 flex h-full items-center justify-center gap-2 rounded-[10px] border border-[#2a3d63] bg-[rgba(7,12,24,0.88)] p-1.5 max-sm:flex-col'>
            <Link
              to='/contact'
              className='anim-glow flex h-16 min-w-[15rem] items-center justify-center rounded-lg border border-transparent bg-[#2f72ff] px-5 text-center text-[1.05rem] font-bold text-white shadow-[0_10px_20px_rgba(47,114,255,0.3)] transition hover:-translate-y-px hover:bg-[#2864e1] max-sm:h-14 max-sm:min-w-0'
            >
              Contact Me
            </Link>
            <Link
          ...
          <div className='anim-fade-right anim-delay-4 flex h-full items-center gap-3 rounded-xl border border-[#27395f] bg-[rgba(7,12,24,0.75)] p-1.5'>
