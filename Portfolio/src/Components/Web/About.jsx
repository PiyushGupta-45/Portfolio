  ...
  return (
    <section className='relative min-h-screen bg-[#020409] px-4 pt-[8.2rem] pb-4 text-[#f3f5fb]'>
      <div className='anim-fade-up mx-auto w-full max-w-[960px] rounded-[20px] border border-[#24314e] bg-[linear-gradient(160deg,rgba(9,14,28,0.86)_0%,rgba(7,11,22,0.92)_100%)] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_20px_50px_rgba(0,0,0,0.45)]'>
        ...
        <p className='anim-fade-up anim-delay-1 mt-4 text-[clamp(1rem,1.4vw,1.2rem)] leading-[1.65] text-[#aeb6cb]'>
        ...
        <p className='anim-fade-up anim-delay-2 mt-4 text-[clamp(1rem,1.4vw,1.2rem)] leading-[1.65] text-[#aeb6cb]'>
        ...
        <div className='anim-fade-up anim-delay-3 mt-5 flex flex-wrap gap-3 max-[720px]:flex-col'>
          <Link to='/work' className='anim-glow rounded-[10px] border border-transparent bg-[#2f72ff] px-5 py-3 text-center text-[0.96rem] font-bold text-white shadow-[0_10px_20px_rgba(47,114,255,0.28)] transition hover:-translate-y-px hover:bg-[#2864e1]'>View My Work</Link>
